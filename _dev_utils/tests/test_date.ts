...
import { LemburCalculator } from '../../backend/src/services/lemburCalculator';
...
async function main() {
    ...
    console.log("Using string for day testing, local string is:", d1.toISOString().substring(0, 10));
