...
const PrintSignature = () => {
    return (
        <div className="print-signature-section" style={{
            ...
            <div className="signature-block" style={{ width: '23%', textAlign: 'center' }}>
                <p style={{ fontWeight: 'bold', margin: '0', fontSize: '0.7rem' }}>Dibuat Oleh:</p>
                <div className="signature-space" style={{ height: '40px' }}></div>
                <div style={{ borderTop: '1px solid black', display: 'inline-block', minWidth: '130px' }}>
            ...
            <div className="signature-block" style={{ width: '23%', textAlign: 'center' }}>
                <p style={{ fontWeight: 'bold', margin: '0', fontSize: '0.7rem' }}>Diketahui Oleh:</p>
                <div className="signature-space" style={{ height: '40px' }}></div>
                <div style={{ borderTop: '1px solid black', display: 'inline-block', minWidth: '130px' }}>
                    <p style={{ fontWeight: 'bold', margin: '3px 0 0 0', fontSize: '0.7rem' }}>Senior Manager</p>
                    <p style={{ fontSize: '0.65rem', fontStyle: 'italic', margin: '0' }}>Senior Manager</p>
                </div>
            </div>
